...
public class ScrapOceanBiome extends BiomeGenBase {
	
	private static final BiomeGenBase.Height height = new BiomeGenBase.Height(-1.0F, 0.1F);

	public ScrapOceanBiome(int par1) {
		super(par1);
