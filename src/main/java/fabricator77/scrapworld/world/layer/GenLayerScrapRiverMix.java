...
public class GenLayerScrapRiverMix extends GenLayer
{
    private GenLayer biomePatternGeneratorChain;
    private GenLayer riverPatternGeneratorChain;

    public GenLayerScrapRiverMix(long par1, GenLayer par3GenLayer, GenLayer par4GenLayer)
    {
        super(par1);
    ...
    public int[] getInts(int par1, int par2, int par3, int par4)
    {
        ...
        for (int i1 = 0; i1 < par3 * par4; ++i1)
        {
            if (aint[i1] != BiomeGenBase.ocean.biomeID && aint[i1] != BiomeGenBase.deepOcean.biomeID)
            {
                ...
                {
                    aint2[i1] = RegisterBiomes.scrapRiver.biomeID;
                }
                else
                {
                    aint2[i1] = aint[i1];
            ...
            {
            	aint2[i1] = RegisterBiomes.scrapOcean.biomeID;
            }
        }
